...
export async function getUserOnboards(req, res) {
    try {
...
export async function postUserOnboards(req, res) {
    try {
...
export async function patchUserOnboards(req, res) {
    try {
...
export async function deleteUserOnboards(req, res) {
    try {
        const paramsuserId = req.params.userId;
        const parsedUserId = parseInt(paramsuserId);
        if (!parsedUserId) {
